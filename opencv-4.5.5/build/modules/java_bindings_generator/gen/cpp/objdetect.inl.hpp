...
#include "/home/lijie/下载/opencv-4.5.5/modules/objdetect/include/opencv2/objdetect.hpp"
#include "/home/lijie/下载/opencv-4.5.5/modules/objdetect/include/opencv2/objdetect/detection_based_tracker.hpp"
#include "/home/lijie/下载/opencv-4.5.5/modules/objdetect/include/opencv2/objdetect/face.hpp"
...
JNIEXPORT jdouble JNICALL Java_org_opencv_objdetect_FaceRecognizerSF_match_10
  (JNIEnv* env, jclass , jlong self, jlong _face_feature1_nativeObj, jlong _face_feature2_nativeObj, jint dis_type)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::FaceRecognizerSF>* me = (Ptr<cv::FaceRecognizerSF>*) self; //TODO: check for NULL
        Mat& _face_feature1 = *((Mat*)_face_feature1_nativeObj);
        Mat& _face_feature2 = *((Mat*)_face_feature2_nativeObj);
        return (*me)->match( _face_feature1, _face_feature2, (int)dis_type );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT jdouble JNICALL Java_org_opencv_objdetect_FaceRecognizerSF_match_11
  (JNIEnv* env, jclass , jlong self, jlong _face_feature1_nativeObj, jlong _face_feature2_nativeObj)
{
    ...
    try {
        ...
        Mat& _face_feature1 = *((Mat*)_face_feature1_nativeObj);
        Mat& _face_feature2 = *((Mat*)_face_feature2_nativeObj);
        return (*me)->match( _face_feature1, _face_feature2 );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
