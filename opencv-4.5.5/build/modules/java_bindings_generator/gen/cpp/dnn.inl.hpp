...
#include "/home/lijie/下载/opencv-4.5.5/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/home/lijie/下载/opencv-4.5.5/modules/dnn/include/opencv2/dnn/dict.hpp"
#include "/home/lijie/下载/opencv-4.5.5/modules/dnn/include/opencv2/dnn/dnn.hpp"
#include "/home/lijie/下载/opencv-4.5.5/modules/dnn/include/opencv2/dnn/utils/inference_engine.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Net_quantize_10 (JNIEnv*, jclass, jlong, jlong, jint, jint);
  ...
  (JNIEnv* env, jclass , jlong self, jlong layer_nativeObj, jint numParam, jlong blob_nativeObj)
{
    ...
    try {
        ...
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        Mat& blob = *((Mat*)blob_nativeObj);
        me->setParam( (*(*(Ptr<cv::dnn::DictValue>*)layer_nativeObj)), (int)numParam, blob );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jlong self, jlong layer_nativeObj, jint numParam)
{
    ...
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getParam( (*(*(Ptr<cv::dnn::DictValue>*)layer_nativeObj)), (int)numParam );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong layer_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getParam( (*(*(Ptr<cv::dnn::DictValue>*)layer_nativeObj)) );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
